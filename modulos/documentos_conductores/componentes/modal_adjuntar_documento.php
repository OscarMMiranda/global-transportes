<?php
// archivo: /modulos/documentos_conductores/componentes/modal_adjuntar_documento.php
?>
...
<div id="modalAdjuntarDocumento"
    ...
    <div style="background:#fff; width:450px; margin:80px auto; padding:20px; border-radius:6px;
        ...
        <h5 id="tituloModalDoc" class="mb-1">Adjuntar documento</h5>

        <!-- Nombre del conductor -->
        <p id="nombreConductorModal" class="text-muted mb-3" style="font-size:0.95rem;"></p>
