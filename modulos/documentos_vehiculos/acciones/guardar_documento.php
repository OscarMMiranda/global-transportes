...
// Ruta correcta
$carpeta = $_SERVER['DOCUMENT_ROOT'] . '/uploads/documentos/vehiculos/';
if (!is_dir($carpeta)) mkdir($carpeta, 0775, true);

$nombreFinal = "veh_{$vehiculoId}_tipo_{$tipoId}_" . time() . "." . $ext;
...
$stmtVer->bind_param("ii", $vehiculoId, $tipoId);
$stmtVer->execute();
