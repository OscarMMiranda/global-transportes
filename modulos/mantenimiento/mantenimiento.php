    ...
    <main class="dashboard-container flex-fill container-fluid px-4 py-4">
        <section class="dashboard-section">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4 dashboard-cards">
                ...
                <?php include __DIR__ . '/componentes/tarjetas/tarjeta_tipo_mercaderia.php'; ?>
                <?php include __DIR__ . '/componentes/tarjetas/tarjeta_tipo_vehiculo.php'; ?>
                <?php include __DIR__ . '/componentes/tarjetas/tarjeta_agencia_aduana.php'; ?>
                <?php include __DIR__ . '/componentes/tarjetas/tarjeta_tipo_documento.php'; ?>
