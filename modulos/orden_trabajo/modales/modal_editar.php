    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title fw-bold">Editar Orden de Trabajo</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formEditarOT">
                    ...
                    <div class="row g-3"><!-- g-3 mejora espaciado -->
                        ...
                        <!-- IMPORTACIÓN -->
                        <div class="col-md-6" id="campo_importacion" style="display:none;">
                        ...
                        <!-- EXPORTACIÓN -->
                        <div class="col-md-6" id="campo_exportacion" style="display:none;">
                        ...
                        <!-- NACIONAL -->
                        <div class="col-md-6" id="campo_nacional" style="display:none;">
            ...
            <div class="modal-footer">
                <button type="submit" form="formEditarOT" class="btn btn-warning fw-semibold">Guardar cambios</button>
