<?php
// archivo: /modulos/orden_trabajo/controllers/ObservarController.php
...
if ($conn->error) {
    echo json_encode([
        "ok" => false,
        "msg" => "Error al observar la OT: " . $conn->error
    ]);
    exit;
}
