<?php
// archivo: /modulos/orden_trabajo/controllers/EliminarController.php
...
if ($conn->error) {
    echo json_encode([
        "ok" => false,
        "msg" => "Error al eliminar la OT: " . $conn->error
    ]);
    exit;
}
...
echo json_encode([
    "ok" => true,
    "msg" => "OT eliminada correctamente (eliminación lógica).",
    "motivo" => $motivo
]);
