<?php
// archivo: /modulos/clientes/ajax/desactivar_cliente.php
...
if (!$conn->query($sql)) {
    ...
    echo json_encode(["status" => "error", "msg" => "No se pudo desactivar el cliente"]);
    exit;
}
