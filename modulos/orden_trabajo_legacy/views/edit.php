<?php
	//  archivo :   /modulos/orden_trabajo/views/edit.php
...
switch ($orden['tipo_ot_id']) {
    case 2: // Importación
        ...
        break;
    case 3: // Exportación
    	$valorDinamico = isset($orden['numero_booking']) ? $orden['numero_booking'] : '';
    break;
    case 1: // Nacional
    $valorDinamico = isset($orden['otros']) ? $orden['otros'] : '';
    break;
}
...
<body>
  <div class="container mt-4">
    ...
    <form method="POST" action="../controllers/EditController.php" class="mt-4">
      <!-- Número de OT oculta -->
      ...
      <a href="../index.php" class="btn btn-secondary">⬅️ Volver a Órdenes</a>
    </form>
  </div>
