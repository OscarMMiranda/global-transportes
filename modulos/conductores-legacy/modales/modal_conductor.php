...
<div class="modal fade" id="modalConductor" tabindex="-1" aria-labelledby="modalConductorLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form id="frmConductor" class="modal-content" data-mode="crear" enctype="multipart/form-data" autocomplete="off">
      
      <!-- Header -->
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title d-flex align-items-center mb-0" id="modalConductorLabel">
          <i class="fa-solid fa-id-card-clip me-2 text-light"></i>
          Ficha del Conductor
        </h5>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-4">
                <label for="c_licencia_conducir" class="form-label">Licencia Nº</label>
