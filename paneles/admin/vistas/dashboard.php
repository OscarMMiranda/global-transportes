    ...
    <div class="container-fluid app-container">
        <div class="row">
            ...
            <main class="col-md-10 col-lg-12 px-md-4">
                ...
                <!-- Bienvenida -->
                <section class="my-2 p-3 rounded shadow-sm border-start border-primary bg-white">
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        <div>
                            <h1 class="fw-bold mb-0 text-dark">
                                Bienvenido, <?php echo htmlspecialchars($_SESSION['usuario']); ?>
                            </h1>
                            <p class="mb-0 text-muted">Sistema ERP de Gestión para Empresa de Transporte</p>
                        </div>

                        <span class="badge bg-primary fs-6 px-3 py-2">Panel Principal</span>
                    </div>
                </section>

                <!-- Documentación -->
                <section class="mb-3">
                    <h4 class="fw-semibold text-secondary border-bottom pb-2">Documentación</h4>
                ...
                <!-- Gestión General -->
                <section class="mb-3">
                    <h4 class="fw-semibold text-secondary border-bottom pb-2">Gestión General</h4>
                    ...
                    <div class="row row-cols-1 row-cols-md-4 g-3 mt-1">
                        ...
                        <?php include __DIR__ . '/../componentes/tarjetas/tarjeta_papeletas.php'; ?>
                    </div>
                </section>

                <!-- Operaciones y Logística -->
                <section class="mb-3">
                    <h4 class="fw-semibold text-secondary border-bottom pb-2">Operaciones y Logística</h4>
                ...
                <section class="mb-3">
                    <h4 class="fw-semibold text-secondary border-bottom pb-2">Administración General</h4>
