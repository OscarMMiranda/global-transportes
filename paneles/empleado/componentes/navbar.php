...
$usuario = isset($_SESSION['usuario']) ? $_SESSION['usuario'] : 'Empleado';
?>
<nav class="navbar navbar-expand-lg navbar-dark bg-warning shadow-sm">
    <div class="container-fluid">
        ...
        <a class="navbar-brand fw-bold" href="/paneles/router_panel.php">
            <i class="fa fa-briefcase me-2"></i> Panel Empleado
        </a>
        ...
        <div class="collapse navbar-collapse" id="menuEmpleado">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/paneles/empleado/controladores/panel_controlador.php">
                        <i class="fa fa-home me-1"></i> Inicio
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/modulos/tareas/mis_tareas.php">
                        <i class="fa fa-tasks me-1"></i> Mis Tareas
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/modulos/documentos_internos/">
